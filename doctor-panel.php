...
<html lang="en">
  ...
  <a class="navbar-brand" href="registration.php"></i> Care Plus</a>
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, #3983fe, #F0F2F0);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #3983fe, #F0F2F0); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
.list-group-item.active {
  z-index: 2;
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #3983fe, #F0F2F0);
    background: linear-gradient(to right, #3983fe, #F0F2F0);
    border-color: #c3c3c3;
}
.text-primary {
