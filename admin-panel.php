...
<html lang="en">
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, #3983fe, #3983fe);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #3983fe, #3983fe); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
